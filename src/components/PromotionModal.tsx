    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md p-0 gap-0 overflow-hidden rounded-2xl border-none bg-primary text-primary-foreground">
        <DialogHeader className="sr-only">
          <DialogTitle>Promoción especial de Día de las Madres</DialogTitle>
          <DialogDescription>
        ...
        <div className="text-primary-foreground p-10 text-center flex flex-col items-center justify-center space-y-2 relative">
          ...
          <p className="text-lg font-medium tracking-wide">
            Envía tus regalos a distancia
          </p>
          <div className="py-4">
            <span className="text-8xl md:text-9xl font-extrabold tracking-tighter">
              10%
            </span>
            <p className="text-2xl font-bold tracking-wider -mt-4">
              DE DESCUENTO
            </p>
          </div>
          ...
          <p className="text-3xl font-bold tracking-wide">10 DE MAYO 2026</p>
